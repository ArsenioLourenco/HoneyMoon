...
import 'package:honeymoon_delicious/src/pages/client/products/list/client_products_list_controller.dart';
...
class _ClientProductListPageState extends State<ClientProductListPage> {
  ...
  Widget _cardProduct(Product product) {
    return GestureDetector(
      onTap: () {
        _con.openBottomSheet(context, product);
      },
      child: Container(
          height: 250,
          child: Card(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style:
                            TextStyle(fontSize: 15, fontFamily: 'NimbusSans'),
                      ),
                    ),
                    Spacer(),
                    Container(
  ...
  Widget _shoppingBag() {
    return GestureDetector(
      onTap: () {
        _con.goToOrdersCreatePage(context);
      },
      child: Stack(
        children: [
          Container(
